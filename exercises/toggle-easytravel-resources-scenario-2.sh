...
read -p "Do you want to enable (1) or disable (2) EasyTravel resource usage scenario #2? Enter 1 or 2 : " -n 1 -r
echo ""
...
then
    ...
    echo $(curl "$EASYTRAVEL_URL:8080/services/ConfigurationService/setPluginEnabled?name=MediumMemoryLeak&enabled=$ENABLE")
else
    echo ""
